...
class Config():
    def __init__(self):
        self.timestep = 0.1
        self.equilibration = 0 # Set equilibration time
        self.observation = 100 # Set time for observation
        self.fps = 60
        # track properties
        self.aggressives = 0.00 # % of aggressive drivers
