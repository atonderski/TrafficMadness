...
\begin{figure}[ht]
    \centering
      \includegraphics[scale=0.2]{figs/velocity_over_time.eps}
...
It can be related to studies that show that placing certain obstacles in front of an emergency exit improves the overall flow REFERENCE.
